...
//const Body = ({user}) => {} -> This is how we drill the props
const Body = () => {
    ...
    */
    ...
    //Modifying component with the help of useContext
        ...
        <div className="flex-wrap flex justify-center">
        {
            ...
            filteredRestaurants?.map((resturants) => {
                return (<Link to={"/restaurant/"+resturants.data.id} key={resturants.data.id}>
                    <RestaurantCard {...resturants.data} />{/*{...user}  Instead of ..user we can also write user={user} */}
                </Link>)}
            ))
        }
        </div>
