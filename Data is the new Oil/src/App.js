...
//Config Driven UI
const AppLayout = () => {
    //For understanding contexts
    const[user,setUser] = useState({
        name:"Dhruv Vashist",
        email:"dvashist19@namasteDev.com"
    })
    return (
        <>
            {/* For assigning real data instead of dummy data we make use of UserContext.Provider */}
        ...
        children:[
         {
            path:"/",
            element:<Body 
            /*This is for Props Drilling
            user={{
                authorName:"Dhruv", /** If you have a state variable inside your parent and you want to access it's value
                inside it's child then that process of passing down the state through props in the heirarchy is called as
                PROPS DRILLING. 
                email:"dvashist19@namasteDev.com"
            }}*/
            />,            
